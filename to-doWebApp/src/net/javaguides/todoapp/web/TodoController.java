...
public class TodoController extends HttpServlet {
	...
	private void listTodo(HttpServletRequest request, HttpServletResponse response)
		...
		List<Todo> listTodo = todoDAO.selectUserTodos(request.getSession().getAttribute("user").toString());
	...
	private void insertTodo(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		System.out.println("isDone: " + request.getParameter("isDone"));
		boolean isDone = Boolean.valueOf(request.getParameter("isDone").toString());
